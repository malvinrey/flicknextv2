...
class HomePage extends StatefulWidget {
  const HomePage({Key? key}) : super(key: key); // Add Key parameter to constructor
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // Sidebar Overlay (Always visible for testing)
          SideBarAnimated(
            onTap: _onSidebarItemTapped,
            widthSwitch: 0.2, // Sidebar width as 20% of screen width
